...
Usage:
    python generates/gen_seed_hospital_information_system_oracle.py --host 34.68.68.86 --port 3333 --user app_user --password app_pass --service-name FREEPDB1 --patients 50 --truncate
"""
import argparse
import random
import string
